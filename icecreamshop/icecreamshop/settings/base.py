...
import os
# EDIT: BASE_DIR is different than the default because this file is in a subfolder
...
# EDIT: secret key set to 0. In production an environment variable will overwrite this
SECRET_KEY = '0'
